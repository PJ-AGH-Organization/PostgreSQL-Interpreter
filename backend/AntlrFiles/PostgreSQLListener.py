...
class PostgreSQLListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by PostgreSQLParser#orderClause.
    def enterOrderClause(self, ctx:PostgreSQLParser.OrderClauseContext):
        pass

    # Exit a parse tree produced by PostgreSQLParser#orderClause.
    def exitOrderClause(self, ctx:PostgreSQLParser.OrderClauseContext):
        pass


    # Enter a parse tree produced by PostgreSQLParser#orderExpression.
    def enterOrderExpression(self, ctx:PostgreSQLParser.OrderExpressionContext):
        pass

    # Exit a parse tree produced by PostgreSQLParser#orderExpression.
    def exitOrderExpression(self, ctx:PostgreSQLParser.OrderExpressionContext):
        pass


    # Enter a parse tree produced by PostgreSQLParser#sortingOperator.
    def enterSortingOperator(self, ctx:PostgreSQLParser.SortingOperatorContext):
        pass

    # Exit a parse tree produced by PostgreSQLParser#sortingOperator.
    def exitSortingOperator(self, ctx:PostgreSQLParser.SortingOperatorContext):
        pass
